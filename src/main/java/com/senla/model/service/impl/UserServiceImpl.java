...
import com.senla.model.exception.SQLErrors;
import com.senla.model.exception.EntityNotFoundException;
import com.senla.model.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public void deleteUser(long userId) {
        ...
        User user = getUser(userId);
        List<Community> communities = communityService.getCommunitiesByAdminUser_Id(userId);
